    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 sm:px-4 sm:py-10">
      <div className="flex h-full w-full flex-col bg-white shadow-2xl sm:h-auto sm:max-w-lg sm:rounded-xl">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4 sm:max-h-[70vh] sm:flex-none">
          ...
          {/*
            Les quatre colonnes de livraison du tableau. Sur telephone la
            liste n'en montre aucune, faute de largeur : la fiche est le
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 rounded-lg border-2 border-blue-400 px-3 py-2.5 text-[12.5px]">
              <div className="col-span-2">
                ...
                {lead.trackingNumber ? (
                  ...
                  <p className="mt-0.5 flex items-start gap-1 font-medium text-red-600">
              ...
              <div>
                ...
                {lead.deliveryStatus ? (
                  <span
                    className={`inline-block rounded-md px-2 py-1 text-[12px] font-medium ${
              ...
              <div>
                <p className="mb-1 text-gray-400">Statut paiement</p>
                {lead.paymentStatus ? (
                  <span
                    className={`inline-block rounded-md px-2 py-1 text-[12px] font-medium ${paymentStatusStyle(
                      lead.paymentStatus
                    )}`}
                  >
                    {lead.paymentStatus}
